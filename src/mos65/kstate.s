...
KERNEL_STATE=$8c        ; kernel state

;
; Kernel variable header
;

KERNEL_VARIABLE_HEADER=$8d  ;kernel variable header
...
ZENITH_CF_ID=ZENITH_VARIABLE_HEADER+43
...
; System Text buffer for print, copy and paste and general usage

;SYSTEM_BUS_HEAD=SYSTEM_RAM_HEADER+251 ; header variable
SYSTEM_BUS_HEAD=ZENITH_VARIABLE_HEADER+45 ; header variable

SYSTEM_BUS_READ_POINTER=SYSTEM_BUS_HEAD ; read pointer of the vector
SYSTEM_BUS_WRITE_POINTER=SYSTEM_BUS_HEAD+1 ; write pointer of the vector

SYSTEM_BUS_LENGHT=SYSTEM_BUS_HEAD+2 ; max lenght of system bus vector
